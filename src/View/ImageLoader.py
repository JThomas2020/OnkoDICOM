...
class ImageLoader(QtCore.QObject):
    ...
    values required to create an instance of the PatientDictContainer,
    that is used to store all the DICOM-related data used to create the
    patient window.
    """
    ...
    def load(self, interrupt_flag, progress_callback):
        ...
        # however it's the best solution I could come up with. If you
        # have a cleaner alternative, please make your contribution.
        ...
        if 'rtss' in file_names_dict:
            ...
            if 'rtdose' in file_names_dict and self.calc_dvh:
                ...
                # large overhead when creating a new process, which ends
                # up making multiprocessing on these platforms more
                # expensive than linear calculation. As such,
                # multiprocessing is only available on Linux until a
