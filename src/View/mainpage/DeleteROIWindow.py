...
class UIDeleteROIWindow():
    def setup_ui(self, delete_roi_window_instance, regions_of_interest,
        ...
        # Initialise the 2 lists for containing the ROI(s) that we are
        # going to keep and delete respectively
        ...
        # Create a horizontal box for holding the 2 lists and the move
        # left, move right buttons
        ...
        # ========================= KEEP BOX ===========================
        # Create a vertical box for holding the label and the tree view
        # for holding the ROIs that we are keeping
        ...
        # ===================== MOVE LEFT/RIGHT BOX ====================
        # Create a vertical box for holding the 2 buttons for moving
        # left and right
        ...
        # ===================== DELETE BOX =============================
        # Create a vertical box for holding the label and the tree view
        # for holding the ROIs that we are deleting
        ...
        # Create a label for the tree view with the list of ROIs to
        # delete
        ...
        # Create a horizontal box to hold 2 action buttons for this
        # window
    ...
    def retranslate_ui(self, delete_roi_window_instance):
        ...
        delete_roi_window_instance.setWindowTitle(_translate(
            "DeleteRoiWindowInstance", "OnkoDICOM - Delete ROI(s)"))
        self.delete_roi_window_title.setText(_translate(
            "DeleteRoiWindowTitle", "Delete ROI(s)"))
        self.delete_roi_window_instruction.setText(_translate(
            "DeleteRoiWindowInstruction",
            "Move the Regions of Interest to be deleted to "
            "the right-hand side or vice versa"))
        self.delete_roi_window_keep_tree_view_label.setText(_translate(
            "DeleteRoiWindowKeepTreeViewLabel", "To Keep"))
        self.delete_roi_window_delete_tree_view_label.setText(_translate(
            "DeleteRoiWindowDeleteTreeViewLabel", "To Delete"))
        self.move_right_button.setText(_translate(
            "MoveRightButton", "Move Right ->>>"))
        self.move_left_button.setText(_translate(
            "MoveLeftButton", "<<<- Move Left"))
        self.delete_roi_window_cancel_button.setText(_translate(
            "DeleteRoiWindowCancelButton", "Cancel"))
        self.delete_roi_window_confirm_button.setText(_translate(
            "DeleteRoiWindowConfirmButton", "Confirm"))
    ...
    def confirm_button_onClicked(self):
        ...
        if confirmation_dialog == QMessageBox.Yes:
            ...
            progress_window.start_deleting(
                self.dataset_rtss, self.regions_of_interest_to_delete)
...
class DeleteROIProgressWindow(QtWidgets.QDialog):
    ...
    def roi_deleted(self, result):
        ...
        :param result: The resulting dataset from the ROI.delete_roi
        function.
        """
