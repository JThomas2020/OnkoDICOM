...
class PatientBar(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.patient_bar_name_info.setSizePolicy(QSizePolicy.MinimumExpanding,
                                                 QSizePolicy.MinimumExpanding)
        self.patient_bar_name_info.resize(self.patient_bar_name_info.sizeHint()
                                          .width(),
                                          self.patient_bar_name_info.sizeHint()
                                          .height())
        ...
        self.patient_bar_id_info.setSizePolicy(QSizePolicy.MinimumExpanding,
                                               QSizePolicy.MinimumExpanding)
        self.patient_bar_id_info.resize(self.patient_bar_id_info.sizeHint()
                                        .width(),
                                          self.patient_bar_id_info.sizeHint()
                                        .height())
        ...
        self.patient_bar_id_info_label.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.Minimum)
        self.patient_bar_id_info_label.resize(self.patient_bar_id_info_label
                                              .sizeHint().width(),
                                                self.patient_bar_id_info_label
                                              .sizeHint().height())
        ...
        self.patient_bar_dob_info.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding)
        self.patient_bar_dob_info.resize(self.patient_bar_dob_info.sizeHint()
                                         .width(),
                                         self.patient_bar_dob_info.sizeHint()
                                         .height())
        ...
        self.patient_bar_dob_info_label.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.Minimum)
        self.patient_bar_dob_info_label.resize(self.patient_bar_dob_info_label
                                               .sizeHint().width(),
                                               self.patient_bar_dob_info_label
                                               .sizeHint().height())
