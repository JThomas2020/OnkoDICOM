###############################################################################
#                                                                             #
#   This file handles all the processes done when opening a new patient       #
#   or opening the program for the first time                                 #
#                                                                             #
###############################################################################
...
# Create the arrays containing the above data and formatting them
# appropriately
new_icd = []
new_hist = []
strg = ''
...
class UiForm(object):
    ...
    def retranslate_ui(self):
        ...
        self.note.setText(_translate("MainWindow",
                                     "Note: There was no csv file containing "
                                     "\"ClinicalData\""
        ...
        self.label_date_diagnosis.setText(_translate("MainWindow",
                                                     "Date of Diagnosis:"))
        ...
        self.label_overall_stage.setText(_translate("MainWindow",
                                                    "Overall Stage:"))
        self.Overall_Stage.setItemText(0, _translate("MainWindow",
                                                     "Select..."))
        ...
        self.Surgery.setItemText(6, _translate("MainWindow",
                                               "Neoadjuvant (Neo)"))
        self.Surgery.setItemText(7, _translate("MainWindow",
                                               "Concurrent (Con)"))
        ...
        self.label_dt_last_existence.setText(_translate(
            "MainWindow", "Date of Last Existence:"))
        ...
        self.label_cancer_death.setText(_translate("MainWindow",
                                                   "Cancer Death:"))
        self.label_death.setText(_translate("MainWindow", "Death:"))
        self.label_regional_control.setText(_translate("MainWindow",
                                                       "Regional Control:"))
        self.label_distant_control.setText(_translate("MainWindow",
                                                      "Distant Control:"))
        self.label_local_control.setText(_translate("MainWindow",
                                                    "Local Control:"))
        ...
        self.Cancer_death.setItemText(1, _translate("MainWindow",
                                                    "Non-cancer death"))
        self.Cancer_death.setItemText(2, _translate("MainWindow",
                                                    "Cancer death"))
        self.Local_control.setItemText(0, _translate("MainWindow",
                                                     "Select..."))
        ...
        self.Regional_Control.setItemText(0, _translate("MainWindow",
                                                        "Select..."))
        self.Regional_Control.setItemText(1, _translate("MainWindow",
                                                        "Control"))
        self.Regional_Control.setItemText(2, _translate("MainWindow",
                                                        "Failure"))
        self.Distant_Control.setItemText(0, _translate("MainWindow",
                                                       "Select..."))
        self.Distant_Control.setItemText(1, _translate("MainWindow",
                                                       "Control"))
        self.Distant_Control.setItemText(2, _translate("MainWindow",
                                                       "Failure"))
        ...
        self.Chemo.setItemText(6, _translate("MainWindow",
                                             "Neoadjuvant (Neo)"))
        ...
        self.Brachy.setItemText(6, _translate("MainWindow",
                                              "Neoadjuvant (Neo)"))
        self.Brachy.setItemText(7, _translate("MainWindow",
                                              "Concurrent (Con)"))
        ...
        self.Immuno.setItemText(6, _translate("MainWindow",
                                              "Neoadjuvant (Neo)"))
        self.Immuno.setItemText(7, _translate("MainWindow",
                                              "Concurrent (Con)"))
        ...
        self.Hormone.setItemText(6, _translate("MainWindow",
                                               "Neoadjuvant (Neo)"))
        self.Hormone.setItemText(7, _translate("MainWindow",
                                               "Concurrent (Con)"))
        ...
        self.label_dt_local_failure.setText(_translate(
            "MainWindow", "Date of Local Failure:"))
        self.label_dt_regional_failure.setText(_translate(
            "MainWindow", "Date of Regional Failure:"))
        self.label_dt_distant_failure.setText(_translate(
            "MainWindow", "Date of Distant Failure:"))
