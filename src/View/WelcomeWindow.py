...
class UIWelcomeWindow(object):
    ...
    def setup_ui(self, welcome_window_instance):
        ...
        self.welcome_window_logo.setPixmap(QtGui.QPixmap(resource_path(
        ...
        # welcome_window_label_font = QtGui.QFont(FontService.
        #     get_instance().font_family(), 18)
        ...
        # welcome_window_slogan_font = QtGui.QFont(FontService.
        #     get_instance().font_family(), 12)
        ...
        self.open_patient_button.setSizePolicy(
    ...
    def retranslate_ui(self, welcome_window_instance):
        ...
        welcome_window_instance.setWindowTitle(_translate(
            "WelcomeWindowInstance", "OnkoDICOM"))
        self.welcome_window_label.setText(_translate("WelcomeWindowInstance",
                                                     "Welcome to OnkoDICOM!"))
        self.welcome_window_slogan.setText(_translate(
            "WelcomeWindowInstance",
            "OnkoDICOM - the solution for producing data for analysis from "
            "your oncology plans and scans."))
        self.open_patient_button.setText(_translate("WelcomeWindowInstance",
                                                    "Continue"))
