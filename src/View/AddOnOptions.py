...
class UIAddOnOptions(object):
    ...
    def setup_ui(self, add_on_options, roi_line, roi_opacity, iso_line,
        ...
        self.line_fill_options = LineFillOptions(self, roi_line,
                                                 roi_opacity, iso_line,
                                                 iso_opacity, line_width)
    ...
    def display(self, index):
        ...
        column is clicked.
        Change the display of the right view of the window in regards to
        the option chosen from the tree.
        """
...
class StandardOrganOptions(object):
    ...
    def create_import_csv_button(self):
        ...
        _translate = QtCore.QCoreApplication.translate
        self.window.import_organ_csv.setText(_translate("Add_On_Options",
                                                        "Import Spreadsheet"))
    ...
    def create_table_view(self):
        ...
        standard_organ_names_header = self.window.table_organ. \
            horizontalHeader()
...
class StandardVolumeOptions(object):
    ...
    def create_table_view(self):
        ...
        self.window.table_volume.horizontalHeaderItem(1).setTextAlignment(
            QtCore.Qt.AlignLeft)
        standard_volume_names_header = self.window.table_volume. \
            horizontalHeader()
...
class PatientHashId(object):
    ...
    def create_note(self):
        ...
        self.window.note.setText(_translate(
            "Add_On_Options",
            "Note: This is a list of all the patients anonymized using "
            "Onko.\n "
...
class ChangeDefaultDirectory(object):
    ...
    def __init__(self, window_options):
        """
        Create the components for the UI of Change Default Directory
        view.
        """
        self.window = window_options
