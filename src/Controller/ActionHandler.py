...
class ActionHandler:
    ...
    def __init__(self, main_page):
        ...
        self.action_add_ons.triggered.connect(
            self.add_on_options_handler)
        ...
        # TODO self.action_clinical_data_export.triggered.connect(clinical
        #  data check)
    ...
    def save_struct_handler(self):
        """
        If there are changes to the RTSTRUCT detected, save the changes
        to disk.
        """
