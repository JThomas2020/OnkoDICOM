...
class AddOnOptions(QtWidgets.QMainWindow, UIAddOnOptions):
    ...
    #   the same logic applies for all                                        #
    #                                                                         #
    ###########################################################################
    # windowing
    @Slot(QtCore.QPoint)
    def on_customContextMenuRequestedWindow(self, pos):
        ...
        if action == modify_row_action:
            ...
            # table.
            # They will only be saved if 'Apply' is pressed before
    ...
    # This option is extra and not fully supported yet,
    # TO DO in the future
    # # ROI from IsoDoses
    ...
    ###########################################################################
    #                                                                         #
    #  This function creates the tree view on the left according to the       #
    #  given data                                                             #
    #                                                                         #
    ###########################################################################
    ...
    def fill_tables(self):
        ...
        # patients anonymised by the software since installation
    ...
    ###########################################################################
    #                                                                         #
    # The following function show a pop up window to add a new entry in       #
