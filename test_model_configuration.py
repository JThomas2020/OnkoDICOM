...
def test_update_default_directory(init_sqlite_config):
    ...
    # Check if the value from database is equal to
    #     the one that we want to update into
...
def test_get_default_directory(init_sqlite_config):
    ...
    # Compare the value returned from get_default_directory()
    #     and the value from database
