        ...
        if which('plastimatch') is not None:
            if hashed_path == '':
                confirm_pyradi = QMessageBox.information(
                    ...
                    "Once started the process cannot be terminated "
                    "until it finishes.",
                    QMessageBox.Yes, QMessageBox.No)
            ...
            exe_not_found = QMessageBox.information(
                ...
                "your system's PATH variable includes the directory where "
...
class PyradiProgressBar(QtWidgets.QWidget):
    ...
    def on_update(self, value, text=""):
        ...
        # The segmentation masks are generated between the range 25
        #     and 50
        elif value == 25:
