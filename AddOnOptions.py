...
class UIAddOnOptions(object):
    ...
    def setup_ui(self, add_on_options, roi_line, roi_opacity, iso_line,
        ...
        add_on_options.setWindowIcon(QtGui.QIcon(resource_path(
            "res/images/btn-icons/onkodicom_icon.png")))

        _translate = QtCore.QCoreApplication.translate
        add_on_options.setWindowTitle(_translate("Add_On_Options",
                                                 "Add-On Options"))
    ...
    def set_layout(self):
        ...
        self.option_layout.addWidget(self.change_default_directory_frame,
                                     1, 0, 1, 3)
    ...
    def init_user_options_header(self):
        """
        Create title that holds the chosen option from the tree and
        its description.
        """
        ...
        self.table_modules.setText(
            " Here are listed all the user options used in Onko. "
            "By using \n Add-On Options you will be able to "
            "Add/Modify/Delete the "
    ...
    def init_tree_list(self):
        ...
        # Triggering the view change according to the row selected
        #     in the tree
...
class WindowingOptions(object):
    ...
    def create_add_button(self):
        ...
        _translate = QtCore.QCoreApplication.translate
        self.window.add_new_window.setText(_translate("Add_On_Options",
                                                      "Add New Window"))
...
class StandardOrganOptions(object):
    ...
    def create_add_button(self):
        ...
        self.window.add_standard_organ_name = QtWidgets.QPushButton(
            self.window.widget)
        self.window.add_standard_organ_name.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        self.window.add_standard_organ_name.setVisible(False)
        _translate = QtCore.QCoreApplication.translate
        self.window.add_standard_organ_name.setText(_translate(
            "Add_On_Options", "Add Standard Name"))
    ...
    def create_import_csv_button(self):
        ...
        self.window.import_organ_csv = QtWidgets.QPushButton(
            self.window.widget)
        self.window.import_organ_csv.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        self.window.import_organ_csv.setVisible(False)
        _translate = QtCore.QCoreApplication.translate
        self.window.import_organ_csv.setText(_translate(
...
class StandardVolumeOptions(object):
    ...
    def create_add_button(self):
        ...
        self.window.add_standard_volume_name = QtWidgets.QPushButton(
            self.window.widget)
        self.window.add_standard_volume_name.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        self.window.add_standard_volume_name.setVisible(False)
        _translate = QtCore.QCoreApplication.translate
        self.window.add_standard_volume_name.setText(_translate(
            "Add_On_Options", "Add Standard Name"))
...
class PatientHashId(object):
    ...
    def create_table_view(self):
        """
        Create a table to hold all the patients and their hash that
        the software has anonymised.
        """
    ...
    def create_note(self):
        ...
        _translate = QtCore.QCoreApplication.translate
        self.window.note.setText(_translate(
            "Add_On_Options", "Note: This is a list of all the patients "
            "anonymized using Onko.\n "
            "It is your responsibility to ensure their privacy."))


class LineFillOptions(object):
    """
    Manage the UI of Line and Fill Configuration options for ROIs
    and Isodoses display.
    """
    ...
    def __init__(self, window_options, roi_line, roi_opacity, iso_line,
        ...
        window_options.fill_options = QtWidgets.QWidget(
            window_options.widget)
    ...
    def set_layout(self):
        ...
        # self.window.fill_options.setGeometry(
        #     QtCore.QRect(290, 90, 451, 370))
    ...
    def create_slider_opacity_roi(self):
        ...
        self.window.opacityLabel_ROI = QtWidgets.QLabel(
            "ROI Fill Opacity: \t {}%".format(int(
                self.window.opacity_ROI.value())))
    ...
    def create_slider_opacity_isodose(self):
        ...
        self.window.opacityLabel_ISO = QtWidgets.QLabel(
            "ISO Fill Opacity: \t {}%".format(int(
                self.window.opacity_ISO.value())))
    ...
    def update_roi_opacity(self):
        ...
        """
        self.window.opacityLabel_ROI.setText(
            "ROI Fill Opacity: \t {}%".format(int(
                self.window.opacity_ROI.value())))
    ...
    def update_iso_opacity(self):
        ...
        """
        self.window.opacityLabel_ISO.setText(
            "ISO Fill Opacity: \t {}%".format(int(
                self.window.opacity_ISO.value())))
...
class ChangeDefaultDirectory(object):
    ...
    def __init__(self, window_options):
        """
        Create the components for the UI of Change
    ...
    def create_change_default_directory_frame(self):
        ...
        # Create a textbox to contain the path to the directory
        ...
        self.change_default_directory_button.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        self.change_default_directory_input_horizontal_box.addWidget(
