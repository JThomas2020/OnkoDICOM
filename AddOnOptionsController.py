...
class AddOnOptions(QtWidgets.QMainWindow, UIAddOnOptions):
    ...
    def __init__(self, window):  # initialization function
        ...
        # each entry will be used as a button to change the view on the
        #     right accordingly
        data = [
            {   "level": 0,
                "dbID": 442,
        ...
        # create a model for the tree view of options and
        #     attach the data
        self.model = QtGui.QStandardItemModel()
        self.treeList.setModel(self.model)
        self.import_data(data)
        self.treeList.expandAll()
        # fill the corresponding tables with the corresponding data
        #     from the csv files
        self.fill_tables()
        ...
        # self.table_roi.setContextMenuPolicy(
    ...
    def on_customContextMenuRequestedWindow(self, pos):
        ...
        if action == modify_row_action:
            ...
            # If Okay is pressed then display the new entries in
            #     the table
